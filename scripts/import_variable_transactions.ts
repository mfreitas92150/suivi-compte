...
// Liste des montants exacts des charges fixes (en absolu)
...
// Liste des montants exacts des revenus (en absolu)
const INCOME_AMOUNTS = [
    2335.08, 173.66, 84.03, 497.35, 500.00, 128.00, 400.00, 80.00, 17.35, 24.03, 60.00, 3500.00, 200.00
];

// Mots-clés pour ignorer les virements internes ou charges spécifiques non couvertes par le montant exact
const EXCLUDE_KEYWORDS = [
    'VIR SEPA MONDEJAR', 'Virement depuis BoursoBank', 'VIR Virement depuis COMPTE SUR LIVRE',
    'REGULARISATION SUITE DOUBLE IMPUTATION'
];
...
async function main() {
    console.log('--- Importation des transactions courantes de Mai 2026 ---');
    ...
    console.log(`[OK] ${count} transactions courantes ont été importées pour Mai 2026.`);
