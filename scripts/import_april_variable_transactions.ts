...
const INCOME_AMOUNTS = [
    3893.03, 2305.21, 1000.00, 30.51, 112.56, 7.50, 17.32, 17.50, 13.10, 13.90, 172.29, 3500.00
];
...
const EXCLUDE_KEYWORDS = [
    ...
    'REGULARISATION SUITE DOUBLE IMPUTATION', 'VIR aide avril'
];
...
async function main() {
    console.log('--- Importation des transactions courantes d\'Avril 2026 ---');
    ...
    if (fs.existsSync(boursoPath)) {
        ...
        for (let i = 1; i < lines.length; i++) {
            ...
            if (!dateOp.startsWith('2026-04')) continue;
    ...
    if (fs.existsSync(lbpPath)) {
        ...
        for (const line of lines) {
            ...
            if (month !== '04' || year !== '2026') continue;
    ...
    console.log(`[OK] ${count} transactions courantes ont été importées pour Avril 2026.`);
